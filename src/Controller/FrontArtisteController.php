...
/**
 * @Route("/mon-espace/artiste")
 */
class FrontArtisteController extends AbstractController
{
    /**
     * @Route("/", name="front_artiste_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="front_artiste_new", methods={"GET", "POST"})
     */
    public function new(Request $request, ArtisteRepository $artisteRepository): Response
    {
        ...
        return $this->renderForm('front_artiste/new.html.twig', [
            'artiste' => $artiste,
            'form' => $form,
        ]);
    }
